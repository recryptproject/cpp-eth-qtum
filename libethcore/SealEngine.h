...
////////////////////////////////////////////////////////////// // recrypt
	void setRecryptSchedule(EVMSchedule _recryptSchedule) const { recryptSchedule = _recryptSchedule; }

	EVMSchedule& getRecryptSchedule() const { return recryptSchedule; }
...
private:
	...
	mutable EVMSchedule recryptSchedule; // recrypt
